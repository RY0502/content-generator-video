...
export function loadAgnesApiKeys(
  ...
  // AGNES_API_KEY is the primary credential; _2, _3, ... are rotations. Keep
  // accepting AGNES_API_KEY_1 for installations that already use it.
  return normalizeKeys([env.AGNES_API_KEY, ...indexed]);
}
...
/** Convert diagnostics to text and remove configured credentials and signed URLs. */
